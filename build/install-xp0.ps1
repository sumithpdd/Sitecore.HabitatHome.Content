...
$sitecoreParams = @{
    ...
    SiteUtilitiesSrc = $SiteUtilitiesSrc
    DEFModuleFullPath = $DEFModuleFullPath	        
    SCProviderDEFModuleFullPath= $SCProviderDEFModuleFullPath
    SQLProviderDEFModuleFullPath= $SQLProviderDEFModuleFullPath
    XconnectProviderDEFModuleFullPath= $XconnectProviderDEFModuleFullPath
    MSDynamicsDEFModuleFullPath= $MSDynamicsDEFModuleFullPath
    SCConnectMSDynamicsModuleFullPath = $SCConnectMSDynamicsModuleFullPath
}
...
function Install-XConnect {
    ...
    try
    {
		Write-Host "Installing XConnect to $XConnectInstallationPath" -ForegroundColor Red
	...
	if($XConnectSqlCollectionUser -ne "sa")
	{
		try
		{
		...
		Write-Host "Setting Collection User rights not required as using sa account." -ForegroundColor Green
	}
}
...
function Install-Sitecore {
    ...
    {
        #Install Sitecore
		Write-Host "Installing Sitecore to $SitecoreInstallationPath" -ForegroundColor Red
